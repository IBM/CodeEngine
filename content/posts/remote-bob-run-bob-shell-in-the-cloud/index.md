...
![Status output showing IBM Cloud login and initial setup](01-status.jpg)
...
![--setup output: building apiserver and job-agent, deploying application](02-setup.jpg)
...
![--new-session output: job submitted, agent ready after 21s, browser opening](03-new-session.jpg)
...
![Browser login screen for the Remote Bob gateway](04-browser-login.jpg)
...
![Bob Shell welcome screen running inside Code Engine](05-bob-shell-welcome.jpg)
...
![Bob Shell capabilities — code, architecture, tooling, data, configuration](06-bob-shell-capabilities.jpg)
...
![--connect output: live session found, browser opening](07-connect.jpg)
...
![Code Engine console showing the job run in Running state](08-ce-job-running.jpg)
...
![Code Engine console showing multiple job runs — one running, one succeeded](09-ce-job-runs.jpg)
